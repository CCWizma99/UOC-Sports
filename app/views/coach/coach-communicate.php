...
<head>
    ...
    <style>
        ...
        @import url(/uoc-sports/public/css/coach/coach-communicate.css);
...
<body class="mesh-sporty">
    <?php
        ...
        require '../app/views/templates/coach/communicate.php';
        require '../app/views/templates/general/footer.php';
    ?>
</body>
<script src="/uoc-sports/public/js/coach/coach-communicate.js"></script>
</html>
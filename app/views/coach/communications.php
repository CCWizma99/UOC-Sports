...
<head>
    ...
    <title>Communications| UOC Sports E-Portal</title>
    ...
    <style>
        ...
        @import url(/uoc-sports/public/css/coach/communications.css);
...
<body class="mesh-sporty">
    <?php
        ...
        require '../app/views/templates/coach/communications.php';

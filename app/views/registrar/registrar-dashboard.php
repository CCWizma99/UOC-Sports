...
<head>
    ...
    <style>
        ...
        @import url(/uoc-sports/public/css/registrar/dashboard.css);
...
<body class="mesh-sporty">
    <?php
        ...
        require '../app/views/templates/registrar/registrar-dashboard.php';
        require '../app/views/templates/general/footer.php';
    ?>
</body>
<script src="/uoc-sports/public/js/registrar/dashboard.js"></script>
</html>
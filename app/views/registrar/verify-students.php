...
<head>
    ...
    <style>
        ...
        @import url(/uoc-sports/public/css/registrar/verify-students.css);
...
<body class="mesh-sporty">
    <?php
        ...
        require '../app/views/templates/registrar/verify-students.php';
        require '../app/views/templates/general/footer.php';
    ?>
</body>
<script src="/uoc-sports/public/js/registrar/verify-students.js"></script>
</html>
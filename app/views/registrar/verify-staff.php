...
<head>
    ...
    <style>
        ...
        @import url(/uoc-sports/public/css/registrar/verify-staff.css);
...
<body class="mesh-sporty">
    <?php
        ...
        require '../app/views/templates/registrar/verify-staff.php';
        require '../app/views/templates/general/footer.php';
    ?>
</body>
<script src="/uoc-sports/public/js/registrar/verify-staff.js"></script>
</html>
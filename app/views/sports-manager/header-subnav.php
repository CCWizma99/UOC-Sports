...
<nav class="sub-nav">
  <ul>
    ...
    <li><a id="sub-schedule" href="/uoc-sports/public/sport-manager/competitions/"<?php echo strpos($currentPage, '/sport-manager/competitions') !== false ? ' class="active"' : ''; ?>>Competitions</a></li>
    <li><a id="sub-team" href="/uoc-sports/public/sport-manager/team/"<?php echo strpos($currentPage, '/sport-manager/team') !== false ? ' class="active"' : ''; ?>>Team</a></li>

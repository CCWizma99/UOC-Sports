...
<div class="container">
    ...
    <section class="section facility-search">
        ...
        <input type="text" id="search_facility_name"
            placeholder="Type a facility name (e.g., Cricket Oval, Tennis Court)..." oninput="searchFacilities()" />
    ...
    <section class="section facility-reservation-container">
        <h3><i class="fas fa-calendar-plus"></i> Reserve a Facility <span
                style="font-size: 0.7rem; color: #4b0082; background: #eee; padding: 2px 5px; border-radius: 4px; vertical-align: middle; margin-left: 10px;"></span>
        </h3>

        <div id="parallelBookingAlert" class="parallel-booking-alert"
            style="display: none; background-color: #fff3cd; color: #856404; border: 1px solid #ffeeba; padding: 12px 15px; border-radius: 8px; margin-bottom: 20px; font-size: 0.9rem; align-items: center; gap: 10px;">
